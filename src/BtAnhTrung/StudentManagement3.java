...
public class StudentManagement3 {
    ...
    //hàm 1:
    public static void displayStudentList(_04_class_object.excercise.Student[] student) {
        for (_04_class_object.excercise.Student element : student) {
            if (element != null) {
    ...
    //hàm 2:
    public static void deleteStudent(_04_class_object.excercise.Student[] student) {
    ...
    //hàm 3:
    public static void editStudentInfo(_04_class_object.excercise.Student[] student) {
    ...
    //hàm 4:
    public static void addNewStudent(_04_class_object.excercise.Student[] student) {
        ...
        _04_class_object.excercise.Student newStudent = new Student(id, name, age, address);
        for (int i = 0; i < student.length; i++) {
            if ((student[i] == null)) {
